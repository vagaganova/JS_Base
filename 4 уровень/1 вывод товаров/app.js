...
let productsAnchorElement = document.querySelector('div.products')
let buttonCollection = document.querySelectorAll('body button')
...
function clickHandler(event) {
    ...
    productsAnchorElement.innerHTML = ''
...
function showCategory(category) {
    for(let product of products[category]){
        productsAnchorElement.insertAdjacentHTML('beforeend',getProductMarkup(product))
    }
}
